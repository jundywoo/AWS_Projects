...
public class AWSQuizComment implements Comparable<AWSQuizComment> {
	...
	public AWSQuizComment quizId(String quizId) {
		this.quizId = quizId;
		return this;
	}

	public AWSQuizComment author(String author) {
		this.author = author;
		return this;
	}

	public AWSQuizComment comment(String comment) {
		this.comment = comment;
		return this;
	}

	public AWSQuizComment date(Date date) {
		this.date = date;
		return this;
	}
	...
	@Override
	public int compareTo(AWSQuizComment o) {
